...
function init() {
    ...
    var torusGeometry = new THREE.TorusGeometry(0.83, 0.1, 64, 16);
    var torus = new THREE.Mesh(torusGeometry, new THREE.MeshBasicMaterial({color: 'cadet blue'}));
    ...
    var controls = new function () {
        ...
        this.redraw = function () {
            ...
            scene.remove(sphere);
            // create a new one
            sphere = new THREE.Mesh(new THREE.SphereGeometry(controls.radius, 20, 20), faceMaterial);
